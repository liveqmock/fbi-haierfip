...
@ManagedBean
@ViewScoped
public class CmsWritebackAction implements Serializable {
    private static final Logger logger = LoggerFactory.getLogger(CmsWritebackAction.class);
...
*/
    ...
    public String onWritebackAll() {
        ...
        try {
            ...
            MessageUtil.addWarn("信贷系统回写处理结束。");
        } catch (Exception e) {
    ...
    public String onWritebackMulti() {
        ...
        try {
            ...
            MessageUtil.addWarn("信贷系统回写处理结束，请查看处理结果明细。");
        } catch (Exception e) {
            logger.error("信贷系统回写时出现错误，请查询。", e);
            MessageUtil.addError("信贷系统回写时出现错误，请查询。");
        }
    ...
    public CmsService getCmsSevice() {
        return cmsSevice;
    }

    public void setCmsSevice(CmsService cmsSevice) {
        this.cmsSevice = cmsSevice;
    }
