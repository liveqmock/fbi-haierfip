...
@ManagedBean
@ViewScoped
public class ZyqdSbsAccountAction implements Serializable {
    private static final Logger logger = LoggerFactory.getLogger(ZyqdSbsAccountAction.class);
