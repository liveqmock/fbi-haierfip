...
@ManagedBean
@ViewScoped
public class BankDirectPayBatchCcmsAction implements Serializable {
    private static final Logger logger = LoggerFactory.getLogger(BankDirectPayBatchCcmsAction.class);
    ...
    private void initDataList() {
        ...
        needQueryBatlList = batchPkgService.selectNeedConfirmBatchRecords(bizType, CutpayChannel.NONE);
