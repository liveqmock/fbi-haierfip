...
@ManagedBean
@ViewScoped
public class SbsAccountAction implements Serializable {
    private static final Logger logger = LoggerFactory.getLogger(SbsAccountAction.class);
    ...
    public String onAccountAll() {
        ...
        try {
            ...
            MessageUtil.addWarn("入帐完成，请进行回写处理。");
        } catch (Exception e) {
