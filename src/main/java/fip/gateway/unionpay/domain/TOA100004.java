...
public class TOA100004 extends TOA {
    ...
    public String toString() {
        ...
        xs.processAnnotations(TOA100004.class);
        return "<?xml version=\"1.0\" encoding=\"GBK\"?>" + "\n" + xs.toXML(this);
    }

    public static TOA100004 getToa(String xml){
        XStream xs = new XStream(new DomDriver());
        xs.processAnnotations(TOA100004.class);
        return (TOA100004)xs.fromXML(xml);
    }
