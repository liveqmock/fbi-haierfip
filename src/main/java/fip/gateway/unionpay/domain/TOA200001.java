...
public class TOA200001 {
    ...
    public String toString() {
        ...
        xs.processAnnotations(TOA200001.class);
        return "<?xml version=\"1.0\" encoding=\"GBK\"?>" + "\n" + xs.toXML(this);
    }
    public static TOA200001 getToa(String xml){
        XStream xs = new XStream(new DomDriver());
        xs.processAnnotations(TOA200001.class);
        return (TOA200001)xs.fromXML(xml);
    }
    ...
    public static void main(String[] argv) {
        ...
        TOA200001 toa = new TOA200001();

        XStream xs = new XStream(new DomDriver());
        xs.processAnnotations(TOA200001.class);
        toa = (TOA200001)xs.fromXML(xml);
